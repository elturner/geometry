				...
				const std::string& outfile_xyz) const
{
	...
	ss.clear();
	ss.str("");
	ss << file_prefix << level_index << ".doors";
	...
	if(!(outfile.is_open()))
	{
		cerr << "[door_finder_t::writedoors]\tUnable to open "
		     << "file for writing: " << ss.str() << endl;
		return -1;
	}	

	/* write header and comments to file */
	outfile << "# Doors file automatically generated by" << endl
		<< "# the 'find_doors' program." << endl
		<< "#" << endl
		<< "# Developed by Eric Turner "
		<< "<elturner@indoorreality.com>" << endl
		<< endl
		<< "# indicates the building level represented" << endl
		<< "level_index " << level_index << endl
		<< endl
		<< "# each door is represented with the following info:"
		<< endl
		<< "# door <endpoint0_x> <endpoint0_y> "
		<< "<endpoint1_x> <endpoint1_y> "
		<< "<floor_height> <ceiling_height> "
		<< "<center3d_x> <center3d_y> <center3d_z>" << endl
		<< "#" << endl
		<< "# Where:" << endl
		<< "#" << endl
		<< "# endpoint0, endpoint1:  "
		<< "2D endpoints of door frame" << endl
		<< "# floor_height, ceiling_height:  "
		<< "vertical extent of door" << endl
		<< "# center3d:  a 3D point at rough center of door" << endl
		<< endl;

	/* write each door position to the file */
	n = this->doors.size();
	for(i = 0; i < n; i++)
		this->doors[i].writedoors(outfile);
