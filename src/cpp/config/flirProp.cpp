...
*	flirProp.cpp
*
*	This class acts as a container for all the flir properties
 ...
 *		1 - Missing Property
 */
int flirProp::assign_props(std::map<std::string,std::string>& property_map) {
...
* laser type objects.
*/
std::string flirProp::type_tag() const {
	return "flirs";
}
