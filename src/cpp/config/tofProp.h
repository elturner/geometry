...
*	tofProp.h
*
*	This class acts as a container for all the time-of-flight camera
...
class tofProp : public sensorProp {
...
public:
	...
	********************************************/
	...
	// This is the name given to the tof camera
	std::string name;

	// This is the type of scanner
	std::string type;

	// This is the serial number of the tof camera
	...
	// This is the euler angle rotations from this frame
	// to a common frame of reference.  It is in degrees.
	std::vector<double> rToCommon;

	// This is the translation vector between this frame
