...
*	barometerProp.h
*
*	This class acts as a container for all the barometer sensors
*	properties that are passed in via xml configuration files
*/

#ifndef _H_BAROMETERPROP_
#define _H_BAROMETERPROP_
...
class barometerProp : public sensorProp {
...
public:
	...
	********************************************/
	...
	// This is the name of the microcontroller
