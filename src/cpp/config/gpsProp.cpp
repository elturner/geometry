...
*	gpsProp.cpp
*
*	This class acts as a container for all the gps properties
 ...
 *		1 - Missing Property
 */
int gpsProp::assign_props(std::map<std::string,std::string>& property_map) {
...
* laser type objects.
*/
std::string gpsProp::type_tag() const {
	return "gps";
};
