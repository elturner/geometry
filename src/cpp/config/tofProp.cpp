...
*	tofProp.cpp
*
*	This class acts as a container for all the tof properties
 ...
 *		1 - Missing Property
 */
int tofProp::assign_props(std::map<std::string,std::string>& property_map) {
