...
//! @brief This function clears all the data members of the E57Root class
	...
	ustring			formatName;			//!< Contains the string \93ASTM E57 3D Image File\94
...
public:
	ustring		idElementName;		//!< The name of the PointRecord element that identifies which group the point is in. The value of this string must be \93rowIndex\94 or \93columnIndex\94
...
//! @brief This function clears all the data members of the Data3D class
	...
	float			temperature;			//!< The ambient temperature, measured at the sensor, at the time of data collection (in degrees Celsius). Shall be ? ?273.15\B0 (absolute zero).
