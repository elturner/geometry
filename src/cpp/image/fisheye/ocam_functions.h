...
/**
 * This function reads the model parameters from binary-formatted file
 *
 * See docs/fileytpes/calib_dats.txt for formatting of binary files.  This
 * information is used to model fisheye lenses, in order to project to
 * and from camera coordinates to world coordinates.
 *
 * @param myocam_model   The output struct to populate with model data
 * @param camera_name    The output string to store the camera name
 * @param filename       The input filename of binary file to parse
 *
...
/*------------------------------------------------------------------------------
 ...
 It computes a transformation from cartesian to polar coordinates
