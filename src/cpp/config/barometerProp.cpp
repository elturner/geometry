...
*	barometerProp.cpp
*
*	This class acts as a container for all the barometer properties
*	that are passed in via the xml config file
*/

#include "barometerProp.h"
 ...
 *		1 - Missing Property
 */
int barometerProp::assign_props(std::map<std::string,std::string>& property_map) {
...
* laser type objects.
*/
std::string barometerProp::type_tag() const {
	return "barometers";
};
